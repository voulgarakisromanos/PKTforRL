...
image_size = 64
env = RoboticEnv(name="Lift", T=Float32, controller="OSC_POSE", enable_visual=false, show=true, horizon=200, image_size=image_size)

BSON.@load "agents/groundtruth/Lift" agent

stop_condition = StopAfterStep(1_000, is_show_progress=!haskey(ENV, "CI"));
